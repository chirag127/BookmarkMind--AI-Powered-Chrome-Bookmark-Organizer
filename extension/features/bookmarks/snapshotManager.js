        ...
        try {
            ...
            try {
                ...
                if (
                    ...
                    settingsResult.bookmarkMindSettings.maxSnapshots !==
                        undefined
                ) {
                    let max = Number.parseInt(
                        settingsResult.bookmarkMindSettings.maxSnapshots,
                        10
                    );
                    // 0 means unlimited
                ...
                console.warn(
                    "Failed to load maxSnapshots setting:",
                    settingsError
                );
            }
    ...
    async runDiagnostics() {
        try {
            ...
            if (repairResult.removed > 0) {
                ...
                Number.parseFloat(storageState?.usagePercent || 0) > 90
            ) {
