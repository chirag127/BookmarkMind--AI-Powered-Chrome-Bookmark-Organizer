...
class SnapshotManager {
  ...
  async _logDetailedError(context, error, additionalData = {}) {
    ...
    console.error('🔴 SNAPSHOT ERROR DETAILS:', JSON.stringify(errorDetails, null, 2));
  ...
  async getSnapshots() {
    try {
      ...
      console.error('🔴 Critical error getting snapshots, returning empty array for graceful degradation');
      return [];
    }
  }
